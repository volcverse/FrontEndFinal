...
function bac(tid){
  ...
  console.log(123);
  if(datasourcetestpublish.length==0)
  axios
    ...
    columns  :[
      {
        ...
        <Card title={<div><DesktopOutlined />  {datasourcetestpublish[text]['paper_id']} {datasourcetestpublish[text]['paper_name']}</div>}  style={{ marginRight: 0,marginLeft: 0 }}>
                  <div class='row1'> <div style={{ textAlign:'right'}}><ReadOutlined /> {datasourcetestpublish[text]['course_id']}  &nbsp;&nbsp;&nbsp; <IdcardOutlined />{datasourcetestpublish[text]['teacher_id']}</div></div>
        </Card>
      },
    ],
  };
  ...
  render() {
    ...
    return (
          ...
          <Content style={{ margin: '24px 16px 0', overflow: 'initial' }}>
            ...
            <Table columns={this.state.columns} dataSource={datasourcetestpublish}/>
