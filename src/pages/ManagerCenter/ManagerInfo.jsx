  ...
  render() {
    return (
      <div>
        ...
        />
        <br /><br />
        <Link to={{ pathname: '/ManagerCenter/ChangeAdmInfo', state: { username: this.state.username, psw: this.state.psw , type:this.state.type} }}>
          <Button>
            编辑信息
          </Button>
        </Link>

        <Link to={{ pathname: '/ManagerCenter/AdmChangePSW', state: { username: this.state.username, psw: this.state.psw, type:this.state.type } }}>
